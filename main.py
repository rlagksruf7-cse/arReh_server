...
class AudioTrack(MediaStreamTrack):
    ...
    def __init__(self,track):
        super().__init__()
        self.track=track
        self.audioGuide=ARguide.audioPlayer()

    async def recv(self):
        frame = await self.track.recv()
        audioFrame=self.audioGuide.getAudioFrame()
        #await asyncio.sleep(audioFrame.time)
        audioFrame.pts=frame.pts
        audioFrame.time_base=frame.time_base
        return audioFrame
...
class VideoTransformTrack(MediaStreamTrack):
    ...
    def __init__(self, track, transform):
        ...
        #Activity=1
        self.guide=ARguide.ARguide(self.transform)
...
async def offer(request):
    ...
    # prepare local media
    # player = MediaPlayer(os.path.join(ROOT, "./audio/testd.wav"))
